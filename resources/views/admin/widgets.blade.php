...
<head>
	...
	<link href="{{ asset ('vendor/adminLumino/css/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ asset ('vendor/adminLumino/css/font-awesome.min.css') }}" rel="stylesheet">
	<link href="{{ asset ('vendor/adminLumino/css/datepicker3.css') }}" rel="stylesheet">
	<link href="{{ asset ('vendor/adminLumino/css/styles.css') }}" rel="stylesheet">
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="{{ route('index') }}"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			<li class="active"><a href="{{ route('widgets') }}"><em class="fa fa-calendar">&nbsp;</em> Widgets</a></li>
			<li><a href="{{ route('charts') }}"><em class="fa fa-bar-chart">&nbsp;</em> Charts</a></li>
			<li><a href="{{ route('elements') }}"><em class="fa fa-toggle-off">&nbsp;</em> UI Elements</a></li>
			<li><a href="{{ route('panels') }}"><em class="fa fa-clone">&nbsp;</em> Alerts &amp; Panels</a></li>
			...
			<li><a href="{{ route('login') }}"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
		</ul>
	</div><!--/.sidebar-->
	...
	<script src="{{ asset ('vendor/adminLumino/js/jquery-1.11.1.min.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/chart.min.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/chart-data.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/easypiechart.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/easypiechart-data.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/bootstrap-datepicker.js') }}"></script>
	<script src="{{ asset ('vendor/adminLumino/js/custom.js') }}"></script>
